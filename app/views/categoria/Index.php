               ...
               <div class="tabela-responsiva pb-4 mt-3">
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            ...
                            <?php foreach ($lista as  $listar) { ?>
                             <tr>
								<td align="center"><?php echo $listar->id_categoria?></td>
                                <td align="left"><?php echo $listar->categoria?></td>
                                											
                                <td align="center"><a href="<?php echo URL_BASE."categoria/edit/".$listar->id_categoria?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>                              </td>									
                                <td align="center"><a href="javascript:;" onclick="return excluir(this)" data-entidade ="categoria" data-id="<?php echo $listar->id_categoria?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a>                                </td>
                             </tr>                                       
