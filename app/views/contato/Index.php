			...
			<div class="p-1">
               ...
               <div class="tabela-responsiva pb-4 mt-3">
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            ...
                            <tbody>  
                                <?php foreach($lista as $conatto) {?>
                             <tr>                                
							   <td align="center"><?php echo $conatto->id_contato?></td>
							   <td align="center"><?php echo $conatto->nome?></td>
								<td align="center"><?php echo $conatto->email?></td>                            											
								<td align="center"><?php echo $conatto->fone?></td>                           											
                                <td align="center"><a href="<?php echo URL_BASE."contato/edit/".$conatto->id_contato?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>                              </td>									
                                <td align="center"><a href="javascript:;" onclick="return excluir(this)" data-entidade ="contato" data-id="<?php echo $conatto->id_contato?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a>                                </td>
							</tr> 
