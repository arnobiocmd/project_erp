	  ...
	  <div id="tab-2">
		...
		<div class="col-4 mb-3">
			...
			<option value="" selected="">Selecione</option>
					...
					<div class="input-grupo">
                 <input type="text" value="<?php echo ($contato->uf) ? $contato->uf : null?>" name="uf" id="" placeholder="Digite aqui..." class="form-campo estado">
