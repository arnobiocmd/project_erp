            ...
            <div class="col-8 px-2">
               <div class="rows">
                    <div class="col-8 mb-3">
                            ...
                            <input type="text" value="<?php echo isset($produto->produto) ? $produto->produto : null ?>" name="produto" placeholder="Digite aqui..." class="form-campo">
                    </div>
				...
				?> 
                    ...
                    <div class="col-4 mb-3">
                            ...
                            <input type="text" name="preco" value="<?php echo isset($produto->preco) ? $produto->preco : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    ...
                    <div class="col-3 mb-3">
                            ...
                            <input type="text" name="custo_atual" value="<?php echo isset($produto->custo_atual) ? $produto->custo_atual : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    <div class="col-3 mb-3">
                            <label class="text-label">Custo Médio</label>
                            <input type="text" name="custo_medio" value="<?php echo isset($produto->custo_medio) ? $produto->custo_medio : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    <div class="col-3 mb-3">
                            <label class="text-label">Custo Produção</label>
                            <input type="text" name="custo_producao" value="<?php echo isset($produto->custo_producao) ? $produto->custo_producao : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    ...
                    <div class="col-4 mb-3">
                            ...
                            <input type="text" name="estoque_minimo" value="<?php echo isset($produto->estoque_minimo) ? $produto->estoque_minimo : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    <div class="col-4 mb-3">
                            <label class="text-label">Estoque Máximo</label>
                            <input type="text" name="estoque_maximo" value="<?php echo isset($produto->estoque_maximo) ? $produto->estoque_maximo : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    <div class="col-4 mb-3">
                            <label class="text-label">Estoque Atual</label>
                            <input type="text" name="estoque_atual" value="<?php echo isset($produto->estoque_atual) ? $produto->estoque_atual : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    <div class="col-4 mb-3">
                            <label class="text-label">Estoque Reservado</label>
                            <input type="text" name="estoque_reservado" value="<?php echo isset($produto->estoque_reservado) ? $produto->estoque_reservado : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
                    <div class="col-4 mb-3">
                            <label class="text-label">Estoque Real</label>
                            <input type="text" name="estoque_real" value="<?php echo isset($produto->estoque_real) ? $produto->estoque_real : null ?>" placeholder="Digite aqui..." class="form-campo">
                    </div>
